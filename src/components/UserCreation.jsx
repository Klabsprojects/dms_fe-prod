...
const UserManagement = () => {
  ...
  const handleSaveEditedBranch = async () => {
    ...
    try {
      ...
      const baseUrl = 'https://santhai.kooturavu.tn.gov.in/api/v1//branch/';
  ...
  useEffect(() => {
    const fetchStores = async () => {
      try {
        const token = localStorage.getItem('authToken');
        const response = await fetch('https://santhai.kooturavu.tn.gov.in/api/v1//master/stores', {
          headers: {
            'Authorization': `Bearer ${token}`,
            'Content-Type': 'application/json'
          }
  ...
  useEffect(() => {
    ...
    if (token) {
      fetch('https://santhai.kooturavu.tn.gov.in/api/v1//master/stores', {
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
        }
                            ...
                            onClick={async () => {
                              try {
                                ...
                                const response = await fetch(
                                  `https://santhai.kooturavu.tn.gov.in/api/v1//user/${selectedUserView.id}`,
                                  {
                                    method: 'PUT',
                                    headers: {
                                      'Content-Type': 'application/json',
                      ...
                      <button
                        onClick={async () => {
                          ...
                          try {
                            ...
                            const response = await fetch(`https://santhai.kooturavu.tn.gov.in/api/v1//user/${userId}/password/reset`, {
                              method: 'PUT',
                              headers: {
                                'Content-Type': 'application/json',
                                Authorization: `Bearer ${token}`,
                                      ...
                                      <button
                                        onClick={async () => {
                                          try {
                                            ...
                                            const response = await fetch(`https://santhai.kooturavu.tn.gov.in/api/v1//user/${departmentId}`, {
                                              method: 'PUT',
                                              headers: {
                                                'Content-Type': 'application/json',
                                                'Authorization': `Bearer ${token}`,
