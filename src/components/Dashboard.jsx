...
const handleCardClick = (status) => {
  ...
  // ✅ Map card keys to correct tabs
  let tab;
  if (status === 'approved') {
    tab = 'approved'; // Orders received by admin (backend status: "Approved")
  } else if (status === 'dispatch') {
    tab = 'dispatch'; // Orders dispatched (backend status: "Dispatch")
  } else if (status === 'received' || status === 'pc' || status === 'invoice' || status === 'payment') {
    tab = 'received'; // Completed orders (backend status: "Received")
  } else {
    tab = status;
  }
...
if (selectedDepartment) {
  ...
  if (selectedDeptObj) {
    params.append('department', selectedDeptObj.name);
  }
}


  // ✅ Pass dep-rep filters (type and branch)
  if (userRole === 'dep-rep') {
  ...
  console.log('🔥 Routing with params:', params.toString());
    ...
    const fetchDepartments = async () => {
      ...
      try {
        const res = await fetch(
          "https://santhai.kooturavu.tn.gov.in/api/v1/user/departments",
          {
            method: "GET",
            headers: {
    ...
    const fetchDashboardData = async () => {
      ...
      try {
        const response = await fetch(
          'https://santhai.kooturavu.tn.gov.in/api/v1///master/report/store-data',
          {
            method: 'GET',
            headers: {
              'Authorization': `Bearer ${token}`,
  ...
  useEffect(() => {
    const fetchRecentIndents = async () => {
      ...
      try {
        const response = await fetch(
          'https://santhai.kooturavu.tn.gov.in/api/v1///indent/report/recent?limit=5',
          {
            method: 'GET',
            headers: {
              Authorization: `Bearer ${token}`,
  ...
  const handleStoreClick = async (storeCode, storeName) => {
    ...
    try {
      const response = await fetch(
        `https://santhai.kooturavu.tn.gov.in/api/v1///master/detail/${storeCode}/store-data`,
        {
          method: 'GET',
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const handlePriceItemsExcel = async () => {
    ...
    try {
      const response = await fetch(
        "https://santhai.kooturavu.tn.gov.in/api/v1///master/detail/rate/comparison",
        {
          method: "GET",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  useEffect(() => {
    const fetchStores = async () => {
      ...
      try {
        const response = await fetch(
          'https://santhai.kooturavu.tn.gov.in/api/v1///master/stores',
          {
            method: 'GET',
            headers: {
              Authorization: `Bearer ${token}`,
    ...
    const fetchDefaultOrders = async () => {
      ...
      try {
        ...
        if (user.role === "rcs-admin") {
          ...
          url = `https://santhai.kooturavu.tn.gov.in/api/v1//indent/report/orders?department=364&period=thisMonth`;
        } else if (user.role === "department") {
          // Department default - no department/store filter
          url = `https://santhai.kooturavu.tn.gov.in/api/v1//indent/report/orders?period=thisMonth`;
          ...
          url = `https://santhai.kooturavu.tn.gov.in/api/v1//indent/report/orders?${branchQuery}&period=thisMonth`;
          ...
          const recentUrl = `https://santhai.kooturavu.tn.gov.in/api/v1//indent/report/recent?${branchQuery}&period=thisMonth&limit=5`;
  ...
  const fetchFilteredData = async (storeId = null, deptId = null, period = null, branch = null) => {
    ...
    try {
      ...
      let url = 'https://santhai.kooturavu.tn.gov.in/api/v1//indent/report/orders?';
      const params = [];
                ...
                <div className="flex gap-3">
                  ...
                  <select
                    ...
                    onChange={(e) => {
                     ...
                     if (selectedStoreObj) {
  fetchFilteredData(selectedStoreObj.id, selectedDepartment || null, selectedPeriod || null);
} else {
                          ...
                          if (branches.length > 0) {
                            ...
                            try {
                              ...
                              const ordersRes = await fetch(
                                `https://santhai.kooturavu.tn.gov.in/api/v1//indent/report/orders?${branchQuery}&period=${period}`,
                                {
                                  method: "GET",
                                  headers: {
                                    Authorization: `Bearer ${token}`,
                              ...
                              const indentsRes = await fetch(
                                `https://santhai.kooturavu.tn.gov.in/api/v1//indent/report/recent?${branchQuery}&period=${period}&limit=5`,
                                {
                                  method: "GET",
                                  headers: {
                                    Authorization: `Bearer ${token}`,
                      ...
                      <select
                        ...
                        onChange={async (e) => {
                          ...
                          try {
                            ...
                            const ordersUrl = `https://santhai.kooturavu.tn.gov.in/api/v1//indent/report/orders?branch=${encodeURIComponent(selected)}&period=${period}`;
                            ...
                            const indentsUrl = `https://santhai.kooturavu.tn.gov.in/api/v1//indent/report/recent?branch=${encodeURIComponent(selected)}&period=${period}&limit=5`;
                            const indentsRes = await fetch(indentsUrl, {
                              method: "GET",
                              headers: {
                                Authorization: `Bearer ${token}`,
                        ...
                        <select
                          ...
                          onChange={async (e) => {
                            ...
                            try {
                              // Fetch Orders
                              const ordersRes = await fetch(
                                `https://santhai.kooturavu.tn.gov.in/api/v1//indent/report/orders?${branchQuery}&period=${value}`,
                                {
                                  method: "GET",
                                  headers: {
                                    Authorization: `Bearer ${token}`,
                              ...
                              // Fetch Indents
                              const indentsRes = await fetch(
                                `https://santhai.kooturavu.tn.gov.in/api/v1//indent/report/recent?${branchQuery}&period=${value}&limit=5`,
                                {
                                  method: "GET",
                                  headers: {
                                    Authorization: `Bearer ${token}`,
                            ...
                            <div className="flex justify-end gap-2 mt-3">
                              <button
                                onClick={async () => {
                                  ...
                                  try {
                                    const ordersRes = await fetch(
                                      `https://santhai.kooturavu.tn.gov.in/api/v1//indent/report/orders?${branchQuery}&period=${customPeriod}`,
                                    ...
                                    const indentsRes = await fetch(
                                      `https://santhai.kooturavu.tn.gov.in/api/v1//indent/report/recent?${branchQuery}&period=${customPeriod}&limit=5`,
                                      { method: "GET", headers: { Authorization: `Bearer ${token}`, "Content-Type": "application/json" } }
                                    );
                                    const indentsResult = await indentsRes.json();
