...
const Stores = () => {
  ...
  const handleAddStore = async () => {
    try {
      ...
      const res = await fetch("https://santhai.kooturavu.tn.gov.in/api/v1/user/store", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
        ...
        body: JSON.stringify({
          ...newStore,
          username: `${newStore.username}@rcs`, // ✅ append @rcs
          location: newStore.location,  // ✅ send lat,lng from map
        }),
      });
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
          {showMapping ? (
            <div className="p-12 text-center">
              <h2 className="text-xl font-semibold text-gray-600 mb-4">Store Mapping Page</h2>
            </div>
          ) : showAddStore ? (
            <div className="p-6 bg-white border rounded-lg shadow-sm">
                ...
                <div>
                  ...
                  <div className="flex items-center">
                    <input
                      ...
                      className="flex-1 px-4 py-2 border rounded-l-md shadow-sm focus:ring-indigo-500 border-gray-300"
                    />
                    <span className="px-3 py-2 border border-l-0 rounded-r-md bg-gray-100 text-gray-600 text-sm">
                      @rcs
                    </span>
                  </div>
                </div>
              ...
              {/* Row 3: Store Official Name + Contact */}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                  ...
                  <div className="flex items-center">
                    <input
                      type="text"
                      value={editValues.username ? editValues.username.replace("@rcs", "") : ""}
                      onChange={(e) =>
                        setEditValues({ ...editValues, username: `${e.target.value}@rcs` })
                      }
                      placeholder="Enter username"
                      className="flex-1 px-4 py-2 border rounded-l-md shadow-sm focus:ring-indigo-500 border-gray-300"
                    />
    ...
    >
      ...
      <span className="text-sm font-medium">Edit</span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="flex gap-2">
                    <span className="text-sm text-gray-500 w-40">Username:</span>
